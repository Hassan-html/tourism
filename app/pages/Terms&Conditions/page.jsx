...
const Time1 = [
  {
    ...
    clickLink: { text: "Explore Packages", src: "/pages/Tours" },
  },
  {
  ...
  return (
    <>
      <section className=" min-h-[400px] ">
        <Banner ForCrumb="Terms&Conditions" />
        <section className="section-1 px-4">
          <div className="secondaryTitle w-fit m-auto">
            Terms And Conditions
          </div>
          <div className="mainTitle w-fit m-auto">Terms And Conditions</div>
